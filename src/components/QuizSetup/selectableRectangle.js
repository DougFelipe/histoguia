  ...
  return (
    <div className="flex flex-col items-center w-11/12 md:w-[64rem]">
      ...
      <div className="flex flex-col w-full items-center justify-beteween md:flex-row md:space-x-8 space-y-4 md:space-y-0">
        <div
          onClick={() => handleSelect('rectangle1')}
          className={`font-inter-semi flex-col p-6 w-11/12 md:w-[26rem]  h-40 flex items-start justify-center cursor-pointer rounded-lg shadow-lg ${selected === 'rectangle1' ? 'border-solid border-4 border-[#3D2E7C]' : 'bg-gray-200 border-4 border-gray-200'
            }`}
        >
        ...
        <div
          onClick={() => handleSelect('rectangle2')}
          className={`font-inter-semi flex-col p-6 w-11/12 md:w-[26rem] h-40 flex items-start justify-center cursor-pointer rounded-lg shadow-lg ${selected === 'rectangle2' ? 'border-solid border-4 border-[#3D2E7C]' : 'bg-gray-200 border-4 border-gray-200'
            }`}
        >
          <span className='text-[#6B7280] text-[14px] font-inter-light'>Selecione o módulo</span>
